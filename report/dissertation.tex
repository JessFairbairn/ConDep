...
\begin{document}
    ...
    One potential field where action primitives may be useful is embodied robotics- if only the set of primitive actions need be hardcoded, complex verb definitions could be learnt in terms of sequences of primitives.
